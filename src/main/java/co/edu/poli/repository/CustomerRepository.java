...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query(
        value = "select distinct customer from Customer customer left join fetch customer.typeDocument",
    ...
    @Query("select distinct customer from Customer customer left join fetch customer.typeDocument")
    List<Customer> findAllWithToOneRelationships();

    @Query("select customer from Customer customer left join fetch customer.typeDocument where customer.id =:id")
