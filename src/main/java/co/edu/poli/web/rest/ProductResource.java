...
import co.edu.poli.repository.ProductRepository;
...
/**
 * REST controller for managing {@link co.edu.poli.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getDescriptionProduct() != null) {
                    existingProduct.setDescriptionProduct(product.getDescriptionProduct());
                }
                if (product.getProductPrice() != null) {
                    existingProduct.setProductPrice(product.getProductPrice());
                }
                if (product.getProductAumount() != null) {
                    existingProduct.setProductAumount(product.getProductAumount());
                }
