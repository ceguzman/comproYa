...
import co.edu.poli.repository.CustomerRepository;
...
/**
 * REST controller for managing {@link co.edu.poli.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getFirstSurname() != null) {
                    existingCustomer.setFirstSurname(customer.getFirstSurname());
                }
                if (customer.getSecondName() != null) {
                    existingCustomer.setSecondName(customer.getSecondName());
                }
                if (customer.getSecondSurname() != null) {
                    existingCustomer.setSecondSurname(customer.getSecondSurname());
                }
